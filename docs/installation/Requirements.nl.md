...
Als je niet van plan bent iets groots uit te voeren, alleen een kleine installatie of een testopstelling, zal Zabbix gelukkig werken op een systeem met 2cpu en 8G ram. Maar alles hangt af van hoe groot uw installatie zal zijn en hoeveel items u gaat monitoren, triggers die u gaat creëren en hoe lang u die gegevens wilt bewaren. Mijn advies in de tijd van virtualisatie is dat je klein kunt beginnen en later meer kunt toevoegen.
